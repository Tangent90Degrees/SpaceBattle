 ...
 * @param gameArea The bounding box of the game area.
 * @param spriteSheet The file name of sprite sheet of the player.
 * @returns The player object.
 */
// const Player = function (ctx, x, y, gameArea, spriteSheet) {
//
